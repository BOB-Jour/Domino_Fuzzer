...
class Domato:
        ...
        for outfile in outfiles:
            ...
            if result is not None:
                ...
                try:
                    ...
                    print('Error writing to output')
        '''
        return self.generate_new_sample(template, htmlgrammar, cssgrammar, jsgrammar)
    ...
    def main(self): 
        ...
        if multiple_samples:
            ...
            nsamples = int(self.get_option('--no_of_files'))
            ...
            self.generate_samples(fuzzer_dir, outfiles)
    
        elif len(sys.argv) > 1:
            outfile = sys.argv[1]
            self.generate_samples(fuzzer_dir, [outfile])
    ...
    def generator(self, template_data): 
        fuzzer_dir = os.path.dirname(__file__) 
        return self.generate_samples2(fuzzer_dir, template_data)
...
<html>
<body>
WebKit Bug 84606 - ASSERT(beforeChildAnonymousContainer->isTable()); fails in LayoutBlockFlow::addChildIgnoringAnonymousColumnBlocks.<br />
